...
impl<'a> SectionReader<'a> {
    ...
    fn read_section(&mut self, fixed_size: Option<usize>) -> Result<Vec<u8>, String> {
        ...
        match self.format {
            ...
            RepFormat::Legacy => self.read_section_legacy(fixed_size),
        }
    }
    ...
    fn read_section_legacy(&mut self, fixed_size: Option<usize>) -> Result<Vec<u8>, String> {
        let size = match fixed_size {
            ...
            None => {
                ...
                if size_buf.len() >= 4 {
                    u32::from_le_bytes([size_buf[0], size_buf[1], size_buf[2], size_buf[3]])
                        as usize
                } else {
        ...
        while pos < block_end {
            ...
            let cmd = match type_id {
                ...
                0x0C => {
                    ...
                    pos += 2;
                    let y = u16::from_le_bytes([data[pos], data[pos + 1]]);
                    pos += 2;
                    let unit_id = u16::from_le_bytes([data[pos], data[pos + 1]]);
                    pos += 2;
                ...
                0x13 => {
                    ...
                    let hotkey_type = HotkeyAction::from_byte(data[pos]);
                    pos += 1;
                    let group = data[pos];
                    pos += 1;
